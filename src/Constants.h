...
//collision config
const float DETECTION_LENGTH = BALL_RADIUS * 2 * 2 ; //collision detection area (nearest neighbor)
const float MIN_VELOCITY_UPDATE = BALL_RADIUS/1000;


//physics config
const float GRAVITY = 9.81 * 0.001;
...
const float FRICTION_COEFFICIENT = 0.0001; // absolute value to be subtracted from velocity
